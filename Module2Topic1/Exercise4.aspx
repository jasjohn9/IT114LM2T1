...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ID="rfvFullName" runat="server" ControlToValidate="fullName" ErrorMessage="Full Name is required." Display="Dynamic"></asp:RequiredFieldValidator>
        ...
        <asp:RangeValidator ID="rvAge" runat="server" ControlToValidate="age" Type="Integer" MinimumValue="0" MaximumValue="100" ErrorMessage="Age must be between 0 and 100." Display="Dynamic"></asp:RangeValidator>
        ...
        <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="email" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" ErrorMessage="Enter a valid email address." Display="Dynamic"></asp:RegularExpressionValidator>
        ...
        <asp:CompareValidator ID="cvConfirmEmail" runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" Operator="Equal" ErrorMessage="Emails do not match." Display="Dynamic"></asp:CompareValidator>
